...
import com.app.model.protocol.UserVideoAuthP;
 ...
 * 视频录制
 */
public  class MediaRecorderActivity extends YFBaseActivity implements
     ...
     * 录制最小时间
     */
    private static int RECORD_TIME_MIN = (int) (5f * 1000);
    /**
     * 刷新进度条
     */
...
//        GO_HOME=mediaRecorderConfig.isGO_HOME();
        MediaRecorderBase.mediaRecorderConfig=new AutoVBRMode();
        MediaRecorderBase.compressConfig=new AutoVBRMode();
    }
    /**
     * 初始化sdk
     * @param context
...
//        mRecordController.setOnTouchListener(mOnVideoControllerTouchListener);
        ...
        mRecordController.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View paramView) {
				...
				if(Recording){
					mRecordController.setBackgroundResource(R.drawable.icon_media_record_start);
					stopRecord();
					
				}
				else{
					mRecordController.setBackgroundResource(R.drawable.icon_media_record_pause);
					startRecord();
...
//        if(compressConfig!=null){
//        	videoFile=mMediaObject.getOutputTempTranscodingVideoPath();
//        }
//        else{
//        	videoFile=mMediaObject.getOutputTempVideoPath();
//        }
//        showProgress("", getResources().getString(R.string.record_camera_progress_message_upload));
//        ControllerFactory.getUserController().uploadVideo(videoFile, mMediaObject.getDuration(), new RequestDataCallback<UserVideoAuthP>() {
//
//			@Override
//			public void dataCallback(UserVideoAuthP obj) {
//				// TODO Auto-generated method stub
//				hideProgress();
//				if(obj!=null){
//					if(obj.getError()==0){
//						showToast(obj.getError_reason());
//						 afterEncode();
//					}
//					else{
//						showToast(obj.getError_reason());
...
//		});
        hideProgress();
        if(compressConfig!=null){
        	mMediaObject.setOutputTempVideoPath(mMediaObject.getOutputTempTranscodingVideoPath());
        }
        Intent intent = new Intent();
        intent.putExtra("data", mMediaObject);
